...
import static com.example.pdfeditormadtpeeps.Utility.FileUtils.getFileNameWithoutExtension;
import static com.example.pdfeditormadtpeeps.Utility.ImageUtils.saveImage;
...
public class PdfToImages extends AsyncTask<Void, Void, Void> {
    ...
    private String mDecryptedPath=null;
    private PDFEncryptionUtility mPDFEncryptionUtility=null;
