...
public class Constants {
    ...
    public static final String DATABASE_NAME = "PdfHeroDB.db";
    ...
    public static final String pdfDirectory = "/mypdf/";
    ...
    public static final String AUTHORITY_APP = "com.example.pdfeditormadtpeeps";
