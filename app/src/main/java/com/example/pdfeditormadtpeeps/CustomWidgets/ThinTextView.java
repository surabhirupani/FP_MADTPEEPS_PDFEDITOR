...
public class ThinTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ThinTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (mTypeface == null) {
            mTypeface = Typeface.createFromAsset(context.getAssets(), "fonts/PoppinsThin.ttf");
        }
